...
`Azurill`: "`Partner Name` and `Hero Name`! Hi there!"


`Partner Normal`

`Partner Name`: "Hey! It's you little guys..."


`Partner Normal`

`Partner Name`: "We heard we have visitors. Are you maybe those visitors?"


`Marill Normal`

`Marill`: "Yep! We wanted to ask Team `Team Name` for help."
...
`Partner Name`: "Isn't that what you were looking for earlier? A Water Float?"
...
`Partner Name`: "There's writing on it."
...
`Partner Name`: "But knowing how weak and puny you are..."


`Partner Normal`

`Partner Name`: "...I bet you can't even reach us! Chaw-haw-haw!"
...
`Partner Name`: "You little guys! Please don't even think about going."


`Partner Surprised`

`Partner Name`: "It's probably a trap!"
...
`Marill`: "But many Electric-type Pokémon live there!"
...
`Partner Name`: "We'll go get the Water Float back for you."
...
`Partner Name`: "Yep! So no more tears!"
...
`Partner Name`: "You should see your faces! All that crying and laughing... C'mon!"


`Partner Normal`

`Partner Name`: "Don't worry, though. We'll get it back for you. We promise!"


`Partner Normal`

`Partner Name`: "Let's go, `Hero Name`! Let's get to Amp Plains!"
