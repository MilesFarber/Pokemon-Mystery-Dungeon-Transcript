...
`Partner Name`: "I couldn't sleep at all..."
...
`Partner Name`: "Can't we be allowed to stay?"


`Partner Sad`

`Partner Name`: "Can't we stay in this world?"


`Partner Sad`

`Partner Name`: "...When we fought Dialga at Temporal Tower..."


`Partner Sad`

`Partner Name`: "You fought even though you knew that you would disappear, `Hero Name`."


`Partner Sad`

`Partner Name`: "Because even if you were to disappear..."
...
`Hero Name`: "(...It's true that I fought Dialga knowing that I would disappear if we succeeded.)"


`Hero Sad`

`Hero Name`: "(But that had to be done to prevent the planet's paralysis.)"


`Hero Sad`

`Hero Name`: "(Back then, I was willing to disappear if it meant saving the world.)"


`Hero Sad`

`Hero Name`: "(I feel the same this time too... But is this situation really the same?)"


`Hero Sad`

`Hero Name`: "(But something...something feels different this time around.)"


`Partner Sad`

`Partner Name`: "Oh, `Hero Name`... What do you think?"


`Partner Sad`

`Partner Name`: "Should we really disappear from this world?"


*If the player chooses "Yes, perhaps...":*
  ...
  * `Partner Name`: "You think so too, `Hero Name`..."
  ...
  * *If the player chooses "But something's weird...":*

  *   * `Partner Sad`

  *   * `Partner Name`: "What? You think something's weird?"


  *   * `Partner Sad`

  *   * `Partner Name`: "What is? What's weird?"
  ...
  *   *   * `Partner Name`: "There's no denying that we changed history..."
  ...
  *   *   * `Partner Name`: "Yep. Remember when we first came back from the future? We slept here?"
  ...
  *   *   * `Partner Name`: "Hmm... I don't truly understand the whole idea of space distortion."


  *   *   * `Partner Sad`

  *   *   * `Partner Name`: "But we were told that we were causing the distortion..."


  *   *   * `Partner Sad`

  *   *   * `Partner Name`: "We were told that at Luminous Spring."


  *   *   * `Partner Sad`

  *   *   * `Partner Name`: "When you think about that, we have to accept that this space distortion is really happening!"


  *   *   * *Jump to [anchor 8](#8)*


  * *If the player chooses "But something's strange...":*

  *   * `Partner Sad`

  *   * `Partner Name`: "Strange? What's strange?"
...
*If the player chooses "I don't know...":*
  ...
  * `Partner Name`: "You must be thinking that maybe we ought to disappear, `Hero Name`..."
