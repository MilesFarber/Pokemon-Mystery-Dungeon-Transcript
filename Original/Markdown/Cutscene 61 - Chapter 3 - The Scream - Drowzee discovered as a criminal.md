...
`Partner Name`: "Oh, looks like he's done."
...
`Bidoof`: "The list of outlaws has been refreshed, so let's pick one."
...
`Partner Name`: "P-p-please look at this, `Hero Name`!"
...
`Bidoof`: "Where are you all off to?"
