...
`Partner Name`: "Luminous Spring must be coming up."
...
`Teddiursa`: "That's just up ahead here."
...
`Teddiursa`: "Want to come with us?"
...
`Partner Name`: "Let's go with them, `Hero Name`!"
