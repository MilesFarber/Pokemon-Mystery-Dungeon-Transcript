...
*Loop forever:*
  ...
  * `Bidoof`: "My wish is... Ummmm... Uuuuummmm..."


  * *If the player chooses "To become rich!":*
...
*If the player chooses "1":*
  ...
  * `Bidoof`: "(Th-that's a really nice wish and all...)"
  ...
  * `Bidoof`: "Is to become the best explorer ever, yup yup."
  ...
  * `Bidoof`: "You've got to work hard... Once you've really done your best...put in the effort, then you can feel like a worthy explorer."
  ...
  * `Bidoof`: "Those are the ways you learn, grow, and get better, little by little. Yup yup."


  * `Bidoof Sad`

  * `Bidoof`: "Yes sirree, I got a lot clearer on all this stuff during this adventure."
  ...
  * `Jirachi`: "You're a good Pokémon, Bidoof. I've come to like you."
  ...
  * `Bidoof`: "Golly, thanks to the Guildmaster and everyone in the guild caring about me... I feel so incredibly happy. Yup!"
  ...
  * `Bidoof`: "If I had a buddy... A pal I could share what I learned with, I'd..."
...
*If the player chooses "2":*
  ...
  * `Bidoof`: "......... (To be the strongest Pokémon...!)"
...
*If the player chooses "3":*
  ...
  * `Bidoof`: "(To become the best explorer ever, yup yup.)"
...
*If the player chooses "4":*
  ...
  * `Bidoof`: "......... (To eat lots of yummy food...!)"
